...
-- -----------------------------------------------------
-- Table `admin_cloud`.`rel_procedimientos_convenios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `admin_cloud`.`rel_procedimientos_convenios` (
  `id_rel_procedimiento_convenio` INT NOT NULL AUTO_INCREMENT,
  `id_convenio` INT NOT NULL,
  `id_procedimiento` INT NOT NULL,
  `tipo_descuento` VARCHAR(100) NULL,
  `valor_descuento` DOUBLE NULL,
  `total` DOUBLE NULL,
  `fecha_creacion` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ultima_edicion` DATETIME NOT NULL,
  `estado` VARCHAR(50) NOT NULL DEFAULT 'activo',
  ...
  PRIMARY KEY (`id_rel_procedimiento_convenio`),
